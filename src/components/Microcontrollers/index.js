            ...
            <div className={'container microcontrollers-page'}>
                <div className={'text-zone'}>
                    ...
                    <p className={'mcu-intro'}>
                        This course delves into the typical structures and applications of microcontroller systems,
                        placing
                        ...
                        micro-to-micro communications. It covers interrupt handling, small system design, and
                        applications
                        using high-level programming languages. Additionally, it introduces microprocessor architecture
                        and
                    ...
                    <p className={'mcu-text'}>
                        <p className={'mcu-text'}>
                            ...
                            module
                            to enable autonomous maneuvering for a robot. This involves sweeping an ultrasonic sensor
                            over a
                            ...
                            members, fostering collaboration and camaraderie. They are required to add any new interests
                            to
                            ...
                            Teams are challenged to compute TimerA0 CCR1 values necessary for producing square wave
                            outputs
                            ...
                            This problem involves initializing TimerA to generate square waves and implementing a
                            playNote()
                            function to manage note playback. The function configures TimerA registers based on note
                            duration and delay constants, facilitating sequential playback of different notes with
                            specified
                            ...
                            <li>Prohibit the use of "Mary Had a Little Lamb" for the assignment, encouraging exploration
                                of
                            ...
                            Through the completion of these tasks, teams will deepen their understanding of TimerA
                            module
                            functionalities, PWM signal generation, and musical note playback. This hands-on experience
                            contributes to their proficiency in microcontroller systems design and implementation,
                            fostering
                    ...
                    <p className={'mcu-text'}>
                        ...
                        microcontroller, particularly in generating PWM signals and measuring event durations. The
                        primary
                        objective involves utilizing a servo motor and an ultrasonic sensing module to achieve
                        autonomous
                        maneuvering for a robot, including sweeping an ultrasonic sensor over a 180-degree arc to
                        measure
                        ...
                        sound pulses and measuring the time taken for echoes to return. Offering reliable non-contact
                        range
                        detection with high precision, it operates within a range of 2 cm to 400 cm or 1" to 13 feet.
                        The
                        ...
                        Controlled by pulse width modulation (PWM) signals, a servo motor's rotation angle is determined
                        by
                        the duration of the input pulse. The servo motor utilized in this lab requires a 20 ms period,
                        with
                        pulse widths ranging from 1 ms to 2 ms. Although ideally, a 1 ms pulse width corresponds to a
                        -90
                        degree rotation, and a 2 ms pulse width to a 90 degree rotation, calibration may be required
                        with
                        inexpensive servos.<br/><br/>

                        <strong>Prior Preparation:</strong><br/>
                        Before undertaking the lab assignment, it's advisable to review research related to servos and
                        SPI,
                        as they serve as a foundational reference for this project.<br/><br/>

                        <strong>Conclusion:</strong><br/>
                        In the end, I gained valuable knowledge and hands-on experience in PWM signal generation,
                        ultrasonic
                        sensing, and servo motor control. This has significantly enhanced my skill set in embedded
                        systems
                    ...
                    <p className={'mcu-text'}>
                        ...
                        modules. Upon completing this project, I gained proficiency in integrating Bluetooth technology
                        to
                        receive data and leveraging it to control the movement of the robot. Additionally, I acquired
                        skills
                        in dynamically displaying this received data on the OLED LCD screen through the UART
                        communication
                        protocol.<br/><br/>
                        ...
                        configure the SPI for OLED LCD usage. Understanding the functionality of pins, such as SPI
                        USC3SIMO,
                        GPIO, and SPI UCA3CLK, is crucial. Notably, the OLED display requires battery power from the
                        TI-RSLK
                        ...
                        proximity. The TI-RSLK employs the CC2650 Module Booster Pack for BLE communication, connecting
                        to
                        the MSP432 via UART1. The SNP-SAP system simplifies BLE communication, with low-level radio
                        details
                        ...
                        Bluetooth modules on the TI-RSLK platform. This hands-on exploration enhanced my understanding
                        of
                    ...
                    <p className={'mcu-text'}>
                        ...
                        The ultimate goal of this lab was to design a sensor system that measured the position of the
                        robot
                        ...
                        where 1 represented a black reading and 0 represented a white reading. The binary sensor
                        response of
                        0b00011000 indicated that the line was centered under the two middle sensors, while all zeros
                        (0b00000000) indicated that the robot was completely off the black line. These sensors were
                        utilized
                        to determine a positional value and make decisions to keep the robot centered on the black
                        line.<br/><br/>

                        The 8-channel reflectance sensor was interfaced to ports 5, 7, and 9 on the TI-RSLK chassis
                        board,
